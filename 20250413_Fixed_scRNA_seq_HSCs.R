...
req_subset <- subset(data.combined, idents = c("4", "11",  "17"), invert=F)
...
req_subset <- subset(req_subset, idents = c("9","10","11","12", "13"), invert =T)
...
FeaturePlot(data.combined, "Igfbp6", label = T)
